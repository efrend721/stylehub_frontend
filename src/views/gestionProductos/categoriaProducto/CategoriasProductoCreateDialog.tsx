...
import type { CreateCategoriaProductoPayload } from './types';

interface Props {
  open: boolean;
  saving: boolean;
  onClose: () => void;
  onSave: (payload: CreateCategoriaProductoPayload) => void;
  fieldErrors: Record<string, string>;
}

export function CategoriasProductoCreateDialog({ open, saving, onClose, onSave, fieldErrors }: Props) {
  ...
  return (
    ...
    >
      <DialogTitle id="create-categoria-dialog-title">Crear Categoría de Producto</DialogTitle>
