// Barrel export para el módulo de Categoría de Producto
import CategoriaProductoPage from './CategoriaProductoPage';
...
export { useCategoriaProducto } from './useCategoriaProducto';
export type { CategoriaProducto, CreateCategoriaProductoPayload, UpdateCategoriaProductoPayload } from './types';
