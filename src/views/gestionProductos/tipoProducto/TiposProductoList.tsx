...
export function TiposProductoList({ items, onEdit, onAskDelete }: Props) {
  const [menuAnchor, setMenuAnchor] = useState<HTMLElement | null>(null);
  const [menuItem, setMenuItem] = useState<TipoProducto | null>(null);

  const openMenuFor = (el: HTMLElement, item: TipoProducto) => {
    setMenuAnchor(el);
    setMenuItem(item);
  };
