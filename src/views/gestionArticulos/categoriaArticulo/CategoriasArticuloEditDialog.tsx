...
interface Props {
  item: CategoriaArticulo | null;
  saving: boolean;
  onClose: () => void;
  onChange: (item: CategoriaArticulo) => void;
  onSave: () => void;
  fieldErrors: Record<string, string>;
}

export function CategoriasArticuloEditDialog({ item, saving, onClose, onChange, onSave, fieldErrors }: Props) {
  const isOpen = !!item;
  ...
  function normalizeForCompare(c: CategoriaArticulo) {
    return {
  ...
  return (
    ...
    >
      <DialogTitle id="edit-categoria-dialog-title">Editar Categoría de Artículo</DialogTitle>
