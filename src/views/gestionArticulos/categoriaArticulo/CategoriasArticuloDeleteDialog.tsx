...
export function CategoriasArticuloDeleteDialog({ open, count, deleting, onCancel, onConfirm }: Props) {
    ...
    >
      ...
      <DialogContent>
        <DialogContentText id="delete-categoria-dialog-description">
          ¿Está seguro de eliminar {count} categoría(s) de artículo? 
          Esta acción no se puede deshacer y puede afectar artículos asociados.
        </DialogContentText>
      </DialogContent>
