...
import type { CreateTipoArticuloPayload } from './types';

interface Props {
  open: boolean;
  saving: boolean;
  onClose: () => void;
  onSave: (payload: CreateTipoArticuloPayload) => void;
  fieldErrors: Record<string, string>;
}

export function TiposArticuloCreateDialog({ open, saving, onClose, onSave, fieldErrors }: Props) {
  ...
  return (
    ...
    >
      <DialogTitle id="create-tipo-dialog-title">Crear Tipo de Artículo</DialogTitle>
