...
export function TiposArticuloDeleteDialog({ open, count, deleting, onCancel, onConfirm }: Props) {
    ...
    >
      ...
      <DialogContent>
        <DialogContentText id="delete-tipo-dialog-description">
          ¿Está seguro de eliminar {count} tipo(s) de artículo? Esta acción no se puede deshacer.
        </DialogContentText>
      </DialogContent>
