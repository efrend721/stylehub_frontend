...
export type ProveedoresHeaderCardProps = {
...
const ProveedoresHeaderCard = forwardRef<HTMLDivElement, ProveedoresHeaderCardProps>(
              ...
              <Stack spacing={1} sx={{ width: '100%' }}>
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                  <Box sx={{ flexGrow: 1, minWidth: 0 }}>
                    <SearchField value={searchValue} onChange={onSearchChange} placeholder="Buscar proveedores" sx={compactSearchSx} />
                  </Box>
...
ProveedoresHeaderCard.displayName = 'ProveedoresHeaderCard';

export default ProveedoresHeaderCard;
