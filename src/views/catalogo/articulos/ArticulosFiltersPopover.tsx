...
import type { Option, ArticulosFilters } from './types';
...
interface Props {
  ...
  setFilters: (next: ArticulosFilters) => void;
  onClearFilters: () => void;
...
export default function ArticulosFiltersPopover({ anchorEl, open, onClose, filters, setFilters, onClearFilters, tipoOptions, categoriaOptions, proveedorOptions, onSearchProveedor, paperSx }: Props) {
  const id = open ? 'articulos-filters-popover' : undefined;
