...
export type ArticulosHeaderCardProps = {
...
const ArticulosHeaderCard = forwardRef<HTMLDivElement, ArticulosHeaderCardProps>(
  ({ mobileHeader, landscapePhone = false, canCreate = true, searchValue, onSearchChange, onOpenFilters, onAdd }, ref) => {
              ...
              <Stack spacing={1} sx={{ width: '100%' }}>
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                  <Box sx={{ flexGrow: 1, minWidth: 0 }}>
                    <SearchField value={searchValue} onChange={onSearchChange} placeholder="Buscar artículos" sx={compactSearchSx} />
                  </Box>
...
ArticulosHeaderCard.displayName = 'ArticulosHeaderCard';

export default ArticulosHeaderCard;
