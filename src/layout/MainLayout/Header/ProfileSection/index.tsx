      ...
      >
        {({ TransitionProps }) => (
          <ClickAwayListener onClickAway={handleClose}>
            <Transitions in={open} {...TransitionProps} sx={{}}>
              <Paper>
                {open && (
                  <MainCard
                    border={false}
                  ...
                  >
                    <Box sx={{ p: 2, pb: 0 }}>
                      <Stack>
                        ...
                        <Typography variant="subtitle2">{user?.correo_electronico || 'Usuario del Sistema'}</Typography>
                      </Stack>
                      <OutlinedInput
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <ListItemText primary={<Typography variant="body2">{isLoading ? 'Cerrando sesión...' : 'Logout'}</Typography>} />
                        </ListItemButton>
                      </List>
                    </Box>
                  </MainCard>
